...
static const CrInput::Button ITEM_BUTTON_TABLE[UiKeyboardConfigWindow::ITEM_BUTTON_MAX][3]
{
    { CrInput::BUTTON_UP , CrInput::BUTTON_MAX , CrInput::BUTTON_MAX } , 
    { CrInput::BUTTON_DOWN , CrInput::BUTTON_MAX , CrInput::BUTTON_MAX } ,
    { CrInput::BUTTON_LEFT , CrInput::BUTTON_MAX , CrInput::BUTTON_MAX } , 
    { CrInput::BUTTON_RIGHT , CrInput::BUTTON_MAX , CrInput::BUTTON_MAX } , 
    { CrInput::BUTTON_DECIDE  , CrInput::BUTTON_JUMP , CrInput::BUTTON_ROTATE_R } , 
    { CrInput::BUTTON_CANCEL , CrInput::BUTTON_MAX , CrInput::BUTTON_MAX } , 
    { CrInput::BUTTON_START , CrInput::BUTTON_MAX , CrInput::BUTTON_MAX } , 
};
...
//            m_Item[item].button.SetPressedCallback(TbCreateMemFunc(this,&Self::onPressedResetButton));
    ...
    for( TbSint32 p = 0; p < TB_ARRAY_COUNT_OF(m_ItemButtonInfo); ++p ){
        for( TbSint32 i = 0; i < ITEM_BUTTON_MAX; ++i ){
            m_ItemButtonInfo[p].buttonKey[i] = CrInput::GetButtonKeyboardKey(p,ITEM_BUTTON_TABLE[i][0]);
        }
    }
}
            ...
            for( TbSint32 p = 0; p < TB_ARRAY_COUNT_OF(m_ItemButtonInfo); ++p ){
                for( TbSint32 i = 0; i < ITEM_BUTTON_MAX; ++i ){
                    for( TbSint32 j = 0; j < ITEM_BUTTON_MAX; ++j ){
                        if( ITEM_BUTTON_TABLE[i][j] == CrInput::BUTTON_MAX ){
                            break;
                        }
                        TbKeyType keyType = m_ItemButtonInfo[p].buttonKey[i];
                        CrInput::BindButtonKeyboardKey(p,ITEM_BUTTON_TABLE[i][j],keyType);
                    }
                }
            }

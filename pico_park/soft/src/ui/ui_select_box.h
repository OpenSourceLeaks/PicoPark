...
class SelectTextBox : public toybox::TbUiTextBox
{
public:
    // コンストラクタ
    SelectTextBox( TbBool hasFrame = TB_FALSE )
...
public:
    ...
    {
        for (TbUint32 i = 0; i < TB_ARRAY_COUNT_OF(m_Arrow); ++i)
        {
            m_Arrow[i].SetEnable(isEnable);
        }
    }

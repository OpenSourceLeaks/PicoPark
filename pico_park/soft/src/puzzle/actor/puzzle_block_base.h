...
class PuzzleBlockBase : public CrActor
{
public:
...
public:
    ...
    // 床設置タイマー
    TbFloat32 GetFallFloorTimer() {
        return m_FallFloorTimer;
    }
...
protected:
    ...
    // 移動可能か
    TbBool IsMovable( const TbPointS32& mov ) {
...
private:
    ...
    // 移動可能か
    TbBool isMovable( const TbPointS32& point , const BlockInfo* block , TbUint32 blockCount , TbBool* isHitMap = NULL );
...
private:
    ...
    TbFloat32           m_FallFloorTimer;           // 落下タイマー

...
{
    -CMN_WINDOW_WIDTH , -60.0f , CMN_WINDOW_WIDTH , 16.0f
};
    ...
    : m_Power(0.0f)
{
    ...
    // 風とのあたりはんてい
    {
        CrActionCollision* windCollision = CreateCollision( WIND_COLLISION_RECT , 0 , TB_TRUE );
 ...
 * @author teco
 */
void SideActionWind::onCollided(CrActionCollision* target)
{

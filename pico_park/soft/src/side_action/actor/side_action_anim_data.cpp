...
static TbFloat32 ANIM_INTERVAL_W = CMN_ANIM_INTERVAL_W;
static TbFloat32 ANIM_FRAME_STEP = CMN_ANIM_FRAME_STEP; // アニメーションのスピード
...
static TbRectF32Pod PLAYER_UV_DEFAULT = { (1.0f) / CMN_TEX_SIZE , (1.0f) / CMN_TEX_SIZE , (31.0f) / CMN_TEX_SIZE , (31.0f) / CMN_TEX_SIZE };
...
static TbAnimationKeyFrameDataRectF32::KeyFrame ANIM_DEFAULT_KEY[] = {
    { 0 , TbRectF32(-CMN_TEX_UV(1),0.0f,0.0f,0.0f) }
};
...
static TbAnimationKeyFrameDataRectF32::KeyFrame ANIM_JUMP_KEY[] = {
    { 0 , TbRectF32(ANIM_INTERVAL_W*5.0f-CMN_TEX_UV(1),0.0f,0.0f,0.0f) }
};
...
// 飛行機アニメーション
static TbAnimationKeyFrameDataRectF32::KeyFrame ANIM_PLANE_KEY[] = {
    { 0 , TbRectF32(0.0f,ANIM_INTERVAL_W*2.0f,0.0f,0.0f) }
};
const TbAnimationKeyFrameDataRectF32 SideActionAnimData::PLAYER_PLANE(ANIM_PLANE_KEY, TB_ARRAY_COUNT_OF(ANIM_PLANE_KEY), TB_ANIMATION_INTERPOLATE_TYPE_CONSTANT, TB_FALSE);

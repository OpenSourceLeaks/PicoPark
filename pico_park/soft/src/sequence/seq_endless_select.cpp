...
* @author teco
*/
SeqEndlessSelect::SeqEndlessSelect(TbSint32 arg)
    : Super(SEQ_ENDLESS_SELECT, "SeqEndlessSelect")
    , m_Phase(0)
    , m_PhaseTime(0.0f)
{
    if (0 <= arg) {
...
* @author teco
*/
SeqEndlessSelect::~SeqEndlessSelect()
{
}
...
* @author teco
*/
void SeqEndlessSelect::OnUpdate()
{

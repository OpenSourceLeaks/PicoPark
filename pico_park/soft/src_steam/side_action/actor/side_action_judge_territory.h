...
#ifndef _INCLUDED_SIDE_ACTION_HEIGHT_TERRITORY_H_
#define _INCLUDED_SIDE_ACTION_HEIGHT_TERRITORY_H_

#include "side_action_judge_base.h"
#include "common/actor/action_actor.h"
#include "ui/ui_message_window.h"

class SideActionJudgeTerritory : public SideActionJudgeBase
{
public:
    
    typedef SideActionJudgeTerritory Self;
    typedef SideActionJudgeBase Super;

public:

    // コンストラクタ
    SideActionJudgeTerritory( TbUint32 tileW , TbUint32 tileH );

    // デストラクタ
    virtual ~SideActionJudgeTerritory();
...
private:
    ...
    ActionActorSpriteHooker m_SpriteHookerBack;
    ActionActorSpriteHooker m_SpriteHookerFront;

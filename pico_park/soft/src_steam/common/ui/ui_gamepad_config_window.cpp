...
void UiGamePadConfigWindow::OnCreated()
{
    ...
    SysInput::SetEnablePad(TB_FALSE);
#if NET_INPUT_ENABLE
    NetInputServer::GetInstance().SetEnableInput(TB_FALSE);
#endif
}
...
{
    SysInput::SetEnablePad(TB_TRUE);
#if NET_INPUT_ENABLE
    NetInputServer::GetInstance().SetEnableInput(TB_TRUE);
#endif

...
// 接触タイプの逆指定
inline CmnContactFace CmnReverseContactType( CmnContactFace type )
{
    if( 0 <= type && type < CMN_CONTACT_MAX ) {
        static const CmnContactFace TABLE[] = {
            CMN_CONTACT_DOWN ,
            CMN_CONTACT_UP , 
            CMN_CONTACT_RIGHT , 
            CMN_CONTACT_LEFT 

...
{
    OSAtomicIncrement32(reinterpret_cast<volatile int*>(target));
}
...
{
    OSAtomicDecrement32(reinterpret_cast<volatile int*>(target));
}
...
{
    OSAtomicAdd32(val,reinterpret_cast<volatile int*>(target));
}
...
TB_FORCE_INLINE TbBool TbAtomicCompareAndSwap32(volatile TbUint32* target,
                                              ...
                                              TbUint32 cmp)
{
    return OSAtomicCompareAndSwap32(cmp,val,reinterpret_cast<volatile int*>(target));
}

...
#ifndef _INCLUDED_TB_STATIC_QUEUE_H_
#define _INCLUDED_TB_STATIC_QUEUE_H_
...
public:
    ...
    void SetEnablePopAuto( TbBool isEnable ) { m_BitArray.SetBit( FLAG_POP_AUTO ); }

    //! 中身が一杯の時に自動ポップをするかどうか
    TbBool IsEnablePopAuto() const { return m_BitArray.Test( FLAG_POP_AUTO ); }
...
#include "tb_static_queue_inl.h" // 実装ファイル

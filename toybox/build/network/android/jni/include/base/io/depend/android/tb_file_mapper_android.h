...
#ifndef _INCLUDED_TB_FILE_MAPPER_ANDROID_H_
#define _INCLUDED_TB_FILE_MAPPER_ANDROID_H_
...
class TbFileMapperAndroid : public TbFileMapper
{
public:

    // コンストラクタ
    TbFileMapperAndroid() 
        : TbFileMapper(TB_FALSE,TB_FALSE) {}

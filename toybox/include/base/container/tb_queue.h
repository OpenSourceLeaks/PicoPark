...
#ifndef _INCLUDED_TB_QUEUE_H_
#define _INCLUDED_TB_QUEUE_H_
...
public:
    ...
    // コンストラクタ
    TbQueue( const Allocator& allocator = Allocator() );

    // コンストラクタ
    TbQueue( TbUint32 capacity , const Allocator& allocator = Allocator() );

...
namespace
{
    ...
    {
        { CMN_TEX_UV_RECT(432,224,4,4) } , // PLACE_LU
        { CMN_TEX_UV_RECT(432,228,4,4) } , // PLACE_LC
        { CMN_TEX_UV_RECT(432,232,4,4) } , // PLACE_LB
        { CMN_TEX_UV_RECT(436,224,4,4) } , // PLACE_UP
        { CMN_TEX_UV_RECT(436,228,4,4) } , // PLACE_IN
        { CMN_TEX_UV_RECT(436,232,4,4) } , // PLACE_BT
        { CMN_TEX_UV_RECT(440,224,4,4) } , // PLACE_RU
        { CMN_TEX_UV_RECT(440,228,4,4) } , // PLACE_RC
        { CMN_TEX_UV_RECT(440,232,4,4) } , // PLACE_RB
    };
